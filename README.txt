...
4. The “proxy_server” runs on the server side. Both “proxy_client_Random” and “proxy_client_Random” run on the client side. “proxy_client_Random” is used to generate random workload, and “repeat_client_Random” is used to generate repeated workload. Make sure that the file “alexa10k.txt” and the client executables are in the directory.
